...
<img alt="Essential Radio Logo" class="logo-overhang" src="ERLogo2.png"/>
<!-- ✅ MAIN PLAYER WRAPPER -->
<div class="strip-container three-panel"><div class="strip-topbar"></div>
<!-- LEFT PANEL -->
...
<div id="now-playing-card" style="position: relative;">
<div id="now-playing">Loading current track…</div>
<div aria-label="Share options" class="np-share-toolbar" id="np-share-toolbar">
<span class="np-share-label">Share:</span>
<a aria-label="Share on Facebook" class="np-share-btn" data-platform="facebook" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fessential.radio" rel="noopener" role="button" target="_blank" title="Facebook" type="button"><svg aria-hidden="true" focusable="false" height="18" viewbox="0 0 16 16" width="18" xmlns="http://www.w3.org/2000/svg">
<path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951" fill="currentColor"></path>
</svg></a><a aria-label="Share on X (Twitter)" class="np-share-btn" data-platform="twitter" href="https://twitter.com/intent/tweet?text=I%27m%20listening%20to%20Essential%20Radio%20https%3A%2F%2Fessential.radio" rel="noopener" role="button" target="_blank" title="X (Twitter)" type="button"><svg aria-hidden="true" focusable="false" height="18" viewbox="0 0 16 16" width="18" xmlns="http://www.w3.org/2000/svg">
...
</svg></a><a aria-label="Share on WhatsApp" class="np-share-btn" data-platform="whatsapp" href="https://api.whatsapp.com/send?text=I%27m%20listening%20to%20Essential%20Radio%20https%3A%2F%2Fessential.radio" rel="noopener" role="button" target="_blank" title="WhatsApp" type="button"><svg aria-hidden="true" focusable="false" height="18" viewbox="0 0 16 16" width="18" xmlns="http://www.w3.org/2000/svg">
...
<img alt="Artwork" class="loaded" id="artwork" src="Essential Radio Logo.png"/>
</div>
</div>
<!-- RIGHT PANEL -->
...
<div id="wxWrap" style="font-family:Inter,sans-serif;background:linear-gradient(135deg,#24243e 0%,#191c29 100%);
...
<select id="locSel" style="background:#222;color:#fed351;border:1px solid #444;
...
<button id="toggleBtn" style="background:#fed351;color:#191c29;font-weight:600;border:none;
...
(() => {
  ...
  const darkHours = (hr < 9 || hr >= 21); // Met Office guidance

  desc = desc.toLowerCase();

  // Suppress sunshine at night or early morning
  if (darkHours && /(sun|sunshine|mostly sunny|sunny intervals)/.test(desc)) {
    return 'Clear';
  }
...
const cur  = d.current,
      nxt  = d.hourly[1],
      // Determine whether to treat the current conditions as "day" or "night".
      //
      // The original code based the "day" flag on astronomical sunrise and sunset
      // times (plus/minus one hour).  This meant that in mid‑summer the code
      // would switch to using daytime descriptions (e.g. "Sunny intervals") as
      // soon as an hour after sunrise, which can be as early as 6 AM in the UK.
      // However, the Met Office defines the daytime period for its public
      // forecast symbols as running from 09:00 until 21:00, and the nighttime
      // period from 21:00 until 09:00【480738903751570†L369-L371】.  To avoid
      // seeing daytime phrases like "sunny intervals" before 9 AM, we instead
      // base the day/night decision on the local clock hour.
      day  = (() => {
...
<!-- SIDE BANNER (Third Panel) -->
<div class="side-banner-panel">
<!-- Social (right column) -->
<div class="side-social">
<div class="side-social-title">Follow Essential Radio</div>
<div class="side-social-row">
<a aria-label="Facebook" class="side-social-btn" href="https://facebook.com/ERadioAyrshire" rel="noopener" target="_blank" title="Facebook">
<!-- Facebook -->
<svg aria-hidden="true" viewbox="0 0 24 24"><path d="M24 12A12 12 0 1 0 10.9 23.9v-8.4H8V12h2.9V9.6c0-2.9 1.8-4.5 4.4-4.5 1.2 0 2.4.1 2.7.1v3h-1.9c-1.5 0-1.8.7-1.8 1.7V12H18l-.4 3.5h-2.6v8.4A12 12 0 0 0 24 12z"></path></svg>
</a>
<a aria-label="X (Twitter)" class="side-social-btn" href="https://x.com/ERadioAyrshire" rel="noopener" target="_blank" title="X (Twitter)">
<!-- X -->
<svg aria-hidden="true" viewbox="0 0 24 24"><path d="M18.24 2h3.36l-7.51 8.74L22 22h-6.86l-4.73-6.83L4.88 22H1.52l7.51-8.74L2 2h6.98l4.38 6.3L18.24 2z"></path></svg>
</a>
<a aria-label="Instagram" class="side-social-btn" href="https://instagram.com/ERadioAyrshire" rel="noopener" target="_blank" title="Instagram">
<!-- Instagram -->
...
<div class="side-listen">
<div class="side-listen-title">Additional Ways to Listen</div>
<!-- Group 1 -->
<div class="listen-group">
<div class="listen-group-title">On your smart speaker</div>
<div class="tile-row">
<a aria-label="Open Essential Radio Alexa Skill" class="tile" href="https://www.amazon.co.uk/REL-MEDIA-Essential-Radio/dp/B0BZPTK8ZF" rel="noopener" target="_blank">
<span class="tile-icon">
<!-- Alexa -->
<svg aria-hidden="true" viewbox="0 0 24 24">
<path d="M12 2a8 8 0 0 0-8 8c0 4.4 3.6 8 8 8h.2c.3 2.2 1.3 3.7 3.4 4-1.1-.9-1.8-2.2-1.8-3.7 3.8-1 6.2-4.5 6.2-8.3a8 8 0 0 0-8-8z"></path>
</svg>
</span>
<span class="tile-caption">Alexa</span>
</a>
</div>
</div>
<!-- Group 2 -->
<div class="listen-group">
<div class="listen-group-title">Download the official apps for Apple and Android</div>
<div class="tile-row">
<a aria-label="Open Essential Radio on the Apple App Store" class="tile" href="https://apps.apple.com/gb/app/essential-radio/id6478086650" rel="noopener" target="_blank">
<span class="tile-icon">
<!-- Apple -->
<svg aria-hidden="true" viewbox="0 0 24 24">
<path d="M16.3 13.2c0-2 1.8-3 1.8-3-.9-1.3-2.3-1.5-2.8-1.5-1.2 0-2.1.8-2.7.8-.6 0-1.4-.8-2.4-.8-1.2 0-2.4.7-3.1 1.9-1.4 2.3-.4 5.7 1 7.7.7 1 1.6 2.1 2.7 2.1 1-.1 1.4-.6 2.5-.6 1 0 1.4.6 2.5.6 1.1 0 1.9-1 2.6-2 0 0-.9-.4-1.4-1.4-.4-.9-.7-2-.7-2.8zM14 5.2c.5-.7.8-1.6.7-2.4-.8.1-1.6.6-2.1 1.3-.4.6-.8 1.5-.7 2.3.9.1 1.7-.4 2.1-1.2z"></path>
</svg>
</span>
<span class="tile-caption">Apple</span>
</a>
<a aria-label="Open Essential Radio on Google Play" class="tile" href="https://play.google.com/store/apps/details?id=com.codewai.radios.uk.essential&amp;hl=en-US" rel="noopener" target="_blank">
<span class="tile-icon">
<!-- Google Play -->
<svg aria-hidden="true" viewbox="0 0 24 24">
<path d="M3 2.8v18.4c0 .5.5.8.9.6l12-6.8c.5-.3.5-1 0-1.2L3.9 2.2c-.4-.2-.9.1-.9.6z"></path>
</svg>
</span>
<span class="tile-caption">Android</span>
</a>
</div>
</div>
<!-- Group 3 -->
<div class="listen-group">
<div class="listen-group-title">Via the My Ayrshire College app</div>
<div class="tile-row">
<a aria-label="Open My Ayrshire College on the Apple App Store" class="tile" href="https://apps.apple.com/gb/app/my-ayrshire-college/id1521950988" rel="noopener" target="_blank">
<span class="tile-icon">
<!-- Mortarboard -->
<svg aria-hidden="true" viewbox="0 0 24 24">
<path d="M12 3 2 8l10 5 10-5-10-5zM6 11v4.5c0 1.7 3 3.5 6 3.5s6-1.8 6-3.5V11l-6 3-6-3z"></path>
</svg>
</span>
<span class="tile-caption">iOS</span>
</a>
<a aria-label="Open My Ayrshire College on Google Play" class="tile" href="https://play.google.com/store/apps/details?id=cloud.myday.ayrshire" rel="noopener" target="_blank">
<span class="tile-icon">
<!-- Mortarboard -->
<svg aria-hidden="true" viewbox="0 0 24 24">
<path d="M12 3 2 8l10 5 10-5-10-5zM6 11v4.5c0 1.7 3.5 3.5 6 3.5s6-1.8 6-3.5V11l-6 3-6-3z"></path>
</svg>
</span>
<span class="tile-caption">Android</span>
</a>
...
<div id="rnh-news-hub" style="margin-top:14px;">
<div style="color:#fed351;font-weight:700;font-size:1.1em;margin-bottom:14px;">Latest News from Radio News Hub</div>
<div id="rnh-news-list">
<div style="color:#bbb;font-size:1em;">Loading headlines…</div>
</div>
</div>
<!-- Ayrshire College Logo & Link -->
<div id="ayrshire-college-logo" style="margin-top:20px;text-align:center;">
<a href="https://www1.ayrshire.ac.uk" rel="noopener" style="text-decoration:none;" target="_blank">
<img alt="Ayrshire College Logo" src="AC_Logo.png" style="width:130px;max-width:100%;display:block;margin:0 auto 6px auto;"/>
<span style="color:#fed351;font-weight:700;font-size:1.05em;display:block;">
      Ayrshire College
    </span>
</a>
</div>
...
<div style="border:1px solid #333;border-radius:12px;padding:22px 18px 12px 18px;box-shadow:0 0 20px rgba(0,0,0,0.21);margin-bottom:0; color:#fff">
...
<img alt="PPL_PRSLogo" src="PPL_PRSLogo.png" style="width:120px;max-width:100%;filter:brightness(1.08)"/>
</div>
</div>
<div style="margin-top:20px;text-align:center;color:#888;font-size:14px;opacity:0.8;">
      Essential Radio © 2025
    </div>
</div>
</div>
<div class="modal" id="requestsModal" style="position:fixed;inset:0;display:none;
   z-index:9999">
<div class="modal-content" style="margin:0;padding:0;border-radius:0;
       position:absolute;inset:0;width:100vw;height:100vh;max-width:none;overflow:hidden">
<!-- Top bar -->
<div style="height:48px;display:flex;align-items:center;
         justify-content:space-between;padding:0 12px;
         border-bottom:1px solid #e5e7eb">
<div style="font-weight:600;color:#00818a"></div>
<button aria-label="Close" onclick="closeModal('requestsModal')" style="border:0;font-size:24px;
                     line-height:1;cursor:pointer">×</button>
</div>
<!-- SCROLLABLE CONTAINER (Full-width & height, minus top bar & bottom link) -->
<div style="position:absolute;top:48px;left:0;right:0;bottom:36px;
                overflow:auto;
                -webkit-overflow-scrolling: touch">
<iframe allowfullscreen="" id="requestsIframe" loading="lazy" src="https://forms.office.com/Pages/ResponsePage.aspx?id=CWFOersEtkWIfvFCzEk3ZoQ5eCgoNHZNotQcUOD47KRUME1NTVZOV0lBU05SWlEwOEc2RkI2SUdRNS4u&amp;embed=true" style="width:100%;min-height:300%;border:none" title="Essential Radio Requests">
</iframe>
</div>
<!-- “Open in new tab” link -->
<a href="https://forms.office.com/Pages/ResponsePage.aspx?id=CWFOersEtkWIfvFCzEk3ZoQ5eCgoNHZNotQcUOD47KRUME1NTVZOV0lBU05SWlEwOEc2RkI2SUdRNS4u" rel="noopener" style="position:absolute;left:12px;bottom:10px;
              font-size:12px;color:#6b7280;text-decoration:underline" target="_blank">
      Open in a new tab
    </a>
</div>
</div>
...
<select id="modalDaySelect" style="padding:8px 12px;border-radius:7px;border:none;color:#111;font-weight:600"></select>
</div>
...
<div class="modal-content" style="max-width:1000px;width:97vw">
<span class="close" onclick="closeModal('playlistModal')">×</span>
<h2 style="margin-top:0;color:#00818a">Essential Radio Playlist</h2>
<img alt="Essential Radio Playlist" class="playlist-image" src="ERPlaylist.png"/>
</div>
</div>
<div class="modal" data-refresh-fn="refreshListenAgain" id="listenModal">
<div class="modal-content" style="max-width:900px;width:97vw">
<span class="close" onclick="closeModal('listenModal')">×</span>
<div style="display:flex;align-items:center;gap:20px;margin-bottom:24px">
<h2 style="margin:0;color:#00818a;font-size:1.5em">Listen Again</h2>
</div>
<div style="border:1px solid #333;border-radius:12px;padding:24px 18px;box-shadow:0 0 20px rgba(0,0,0,0.28); color:#eee">
...
<div style="border:1px solid #333;border-radius:12px;padding:0 0 20px 0;box-shadow:0 0 20px rgba(0,0,0,0.23);margin-bottom:0; color:#eee">
<!-- Original intro wording -->
<div class="content-card" style="border:1px solid #343648;border-radius:16px;padding:24px 18px 12px 18px;max-width:850px;margin:24px auto 16px auto;box-shadow:0 0 18px #0008">
...
<div class="container" style="border-radius:18px;box-shadow:0 0 18px #0008;max-width:850px;margin:0 auto 36px auto;padding:20px 18px 32px 18px">
...
<input id="searchInput" placeholder="Search by Artist or Title..." type="text"/>
<button id="resetFilters">Reset</button>
<button id="songsearchRefreshBtn">Refresh</button>
</div>
<table style="width:100%;border-collapse:collapse;margin-top:0.7rem;color:#fff;font-size:17px;border-radius:8px;overflow:hidden">
<thead style="color:#7e1974;font-size:17.5px">
<tr>
<th>Time</th>
<th>Artist – Title</th>
</tr>
...
<div class="no-results" id="noResultsMessage" style="display: none;text-align:center;font-style:italic;color:#fed351;padding:1.4rem 0 0.7rem 0;font-size:18px;letter-spacing:0.1px">No tracks found for this time period.</div>
</div>
...
<div class="modal" id="contactModal" style="position:fixed;inset:0;display:none;
   z-index:9999">
<div class="modal-content" style="margin:0;padding:0;border-radius:0;
       position:absolute;inset:0;width:100vw;height:100vh;max-width:none;overflow:hidden">
<!-- Top bar -->
<div style="height:48px;display:flex;align-items:center;
         ...
         border-bottom:1px solid #e5e7eb">
<div style="font-weight:600;color:#00818a"></div>
<button aria-label="Close" onclick="closeModal('contactModal')" style="border:0;font-size:24px;
                     line-height:1;cursor:pointer">×
      </button>
</div>
<!-- Embed area -->
<div style="position:absolute;top:48px;left:0;right:0;bottom:0">
<div class="embed-wrap" style="min-height:80vh;height:80vh;
           width:100%;overflow:hidden">
<iframe allowfullscreen="" id="contactIframe" loading="lazy" mozallowfullscreen="" msallowfullscreen="" src="https://forms.office.com/Pages/ResponsePage.aspx?id=CWFOersEtkWIfvFCzEk3ZoQ5eCgoNHZNotQcUOD47KRUQ1A2NUlNMkpFTDY2RkJBU0tUMFdJR0YyVC4u&amp;embed=true" style="width:100%;height:100%;border:none" title="Essential Radio Contact">
</iframe>
</div>
</div>
<!-- “Open in new tab” link -->
<a href="https://forms.office.com/Pages/ResponsePage.aspx?id=CWFOersEtkWIfvFCzEk3ZoQ5eCgoNHZNotQcUOD47KRUQ1A2NUlNMkpFTDY2RkJBU0tUMFdJR0YyVC4u" rel="noopener" style="position:absolute;left:12px;bottom:10px;
              font-size:12px;color:#6b7280;text-decoration:underline;" target="_blank">
      Open in a new tab
    </a>
</div>
</div>
<div aria-labelledby="localModalTitle" aria-modal="true" class="modal" id="localModal" role="dialog">
<div class="modal-content" style="max-width:1000px;width:97vw;">
<span aria-label="Close" class="close" onclick="closeModal('localModal')">×</span>
<h2 id="localModalTitle" style="margin-top:0;color:#00818a;">Local Events</h2>
<!-- Controls -->
<div style="display:flex;flex-wrap:wrap;gap:10px;align-items:center;margin:8px 0 16px 0;">
<label><strong>Council:</strong></label>
<select id="localAreaSel">
<option value="north">North Ayrshire</option>
<option value="south">South Ayrshire</option>
<option value="east">East Ayrshire</option>
<option value="all">All</option>
</select>
<label><strong>From:</strong></label>
<input id="localFromDate" type="date"/>
<label><strong>To:</strong></label>
<input id="localToDate" type="date"/>
<input id="localSearch" placeholder="Search title, venue, town…" style="flex:1;min-width:160px;" type="text"/>
<button id="localReset">Reset</button>
</div>
<!-- Events output -->
<div id="localEventsWrap"></div>
<!-- Small helper note -->
<div style="margin-top:10px;color:#666;font-size:0.92em;">
      Tip: use the Council dropdown to switch between North, South and East Ayrshire.
    </div>
</div>
</div>
<div class="modal" data-refresh-fn="refreshAllTravelIframes" id="travelModal">
<div class="modal-content" style="max-width:900px;width:97vw">
<span class="close" onclick="closeModal('travelModal')">×</span>
<div style="display:flex;align-items:center;gap:18px;margin-bottom:20px">
<h2 style="margin:0;color:#00818a;font-size:1.3em">Travel &amp; Transport</h2>
</div>
<div style="border:1px solid #333;border-radius:12px;padding:24px 18px 24px 18px;box-shadow:0 0 20px rgba(0,0,0,0.20);margin-bottom:0; color:#eee">
...
<button onclick="refreshCombinedTravel()" style="color:#191c29;font-weight:600;border:none;border-radius:6px;padding:4px 14px;margin-bottom:8px;cursor:pointer;box-shadow:0 1px 4px rgba(0,0,0,0.2);font-size:1em">
      🔄 Refresh
    </button>
<iframe height="700" id="combined-travel-iframe" loading="lazy" src="https://travel-ac.vercel.app/Current_Combined_Travel_Report.html" style="border-radius:10px;border:none;overflow:hidden;box-shadow:0 2px 14px #0004" title="Combined Travel Report" width="100%">
</iframe>
</div>
</details>
<details style="margin-bottom:20px">
...
<div style="margin:10px 0 0 0">
<iframe height="340" loading="lazy" src="https://travel-ac.vercel.app/Current_Incidents_Traffic_Scotland.html" style="border-radius:10px;border:none;box-shadow:0 2px 14px #0004" title="Current Incidents" width="100%"></iframe>
</div>
</details>
<details style="margin-bottom:20px">
...
<div style="margin:10px 0 0 0">
<iframe height="420" loading="lazy" src="https://travel-ac.vercel.app/Current_Hotspots_Traffic_Scotland.html" style="border-radius:10px;border:none;box-shadow:0 2px 14px #0004" title="Current Road Delays &amp; Hotspots" width="100%"></iframe>
</div>
</details>
<details style="margin-bottom:20px">
<summary style="font-size:18px;font-weight:600;color:#fed351;cursor:pointer;outline:none">🚧 Current Roadworks &amp; Closures</summary>
<div style="margin:10px 0 0 0">
<iframe height="340" loading="lazy" src="https://travel-ac.vercel.app/Current_Roadworks_Traffic_Scotland.html" style="border-radius:10px;border:none;box-shadow:0 2px 14px #0004" title="Current Roadworks" width="100%"></iframe>
</div>
</details>
<details>
...
<div style="margin:10px 0 0 0">
<iframe height="360" loading="lazy" src="https://travel-ac.vercel.app/Scotrail_Incidents.html" style="border-radius:10px;border:none;box-shadow:0 2px 14px #0004" title="ScotRail Live Updates" width="100%"></iframe>
</div>
</details>
</div>
<div style="margin-top:18px;text-align:center;color:#888;font-size:14px;opacity:0.8">
...
<!-- Removed duplicate modal JS script -->
...
async function fetchNowPlaying() {
  try {
    ...
    if (sep) {
      const idx = raw.indexOf(sep); // ✅ FIX: was lastIndexOf
      artist = raw.substring(0, idx).trim();
      title  = raw.substring(idx + sep.length).trim();
    
    } else {
      // Fallback: try simple "Artist, Title" (split on the FIRST comma)
      const c = raw.indexOf(',');
      if (c > 0) {
        artist = raw.slice(0, c).trim();
        title  = raw.slice(c + 1).trim();
        if (!artist || !title) {
          showMoreMusicSoon(); // missing parts after split
          return;
        }
      } else {
        // No valid title/artist format
        showMoreMusicSoon();
        return;
      }
    }
    ...
    if (trackEndTime && now < trackEndTime && startTime < trackEndTime) {
      console.log("Stale metadata ignored — track already ended.");
      return;
    }
...
function startIntervals() {
  if (!nowPlayingInterval) nowPlayingInterval = setInterval(fetchNowPlaying, 15000);
  if (!recentInterval) recentInterval = setInterval(fetchRecentFromGitHub, 15000);
}
...
// Always fetch once on page load
fetchNowPlaying();
fetchRecentFromGitHub();
startIntervals();

// On tab visibility change, only run when visible
...
<!-- Removed duplicate show title formatter script -->
<script>
...
<!-- Removed redundant modal open/close script; bounce handling moved to unified script -->
<script>
...
<!--  FULL PRESENTER MODALS - now with presenter-modal class -->
<!-- ✅ ESSENTIAL RADIO PRESENTERS MODAL – FULL WORKING BLOCK -->
<script>
...
function closeModal(id) {
  ...
  // Only remove modal-open if no modals are open
...
function openPresenterModal(modalId) {
  closeAllModals();
...
</script><div class="modal presenter-modal" id="presenter-paul-woodland" style="z-index: 10001">
<div class="modal-content" style="max-width:600px;">
<span class="close" onclick="closePresenterModal('presenter-paul-woodland')">×</span>
<h2>Paul Woodland</h2>
<!-- Presenter Image -->
<img alt="Paul Woodland" src="Paul-Woodland.jpg" style="width:100%;max-width:220px;margin-bottom:15px;border-radius:12px;"/>
<!-- Presenter Intro -->
<p>Paul is the voice of <strong>Essential Breakfast</strong> every weekday morning – bringing you music, info and morning mayhem to start the day right.</p>
<!-- Full Presenter Bio -->
<p>Paul worked full-time on FM station <strong>90.1 Hope FM</strong> until 2010. Alongside his weekday afternoon show (2–5pm), he managed the production studio, created on-air content, handled advertiser requirements and maintained the music library. In the absence of the station manager, he also stepped into that leadership role.</p>
<p>After relocating to Scotland in 2011, Paul earned an <strong>HNC in Radio</strong> from Edinburgh College and continued with an <strong>HND in Radio</strong> at City of Glasgow College. He went on to found and run <strong>Scene Radio</strong> – Scotland’s first LGBT+ radio station – until its closure in 2018 following the passing of his partner.</p>
<p>Since then, Paul has stayed active in radio on a voluntary basis with stations such as <strong>Xpress Radio Scotland</strong>, <strong>The Online Station</strong>, <strong>Irvine Beat</strong> and <strong>UWS Radio</strong>. His passion for broadcasting continues to shine every morning on Essential Radio.</p>
</div>
</div><div class="modal presenter-modal" id="presenter-bex-mcnamee" style="z-index: 10001">
<div class="modal-content" style="max-width:600px;">
<span class="close" onclick="closePresenterModal('presenter-bex-mcnamee')">×</span>
<h2>Bex McNamee</h2>
<!-- Presenter Image -->
<img alt="Bex NcNamee" src="Bex-Mcnamee.jpg" style="width:100%;max-width:220px;margin-bottom:15px;border-radius:12px;"/>
<p>Bex brings fun, energy and student buzz to <strong>Feelgood Lunch</strong> and <strong>The Midweek Mash-Up</strong>.</p>
<p>She describes her life as a daily cartoon episode – full of unpredictability and humour. A lover of 2000s pop culture, Bex is big on Buffy, Scooby-Doo, 80s hip-hop and anything with nostalgia and chaos mixed in.</p>
<h3>Get to know Bex</h3>
<ul>
<li><strong>When do you pack for a holiday?</strong> About 2 hours before leaving!</li>
<li><strong>In the fridge:</strong> Energy drinks and strawberries</li>
<li><strong>Movie star alter-ego:</strong> Early 2000s Sarah Michelle Gellar (wishful thinking!)</li>
<li><strong>Biography title:</strong> <em>Young Dumb n Broke</em></li>
<li><strong>Most bizarre experience:</strong> “My whole life feels like one – I live like a cartoon character”</li>
<li><strong>Most embarrassing moment:</strong> Calling teachers “mum”... too many times</li>
<li><strong>Dream app:</strong> A competitive subtitle game that could land you work with Netflix</li>
<li><strong>Spotify shame or pride?</strong> “Sure, but it’s full of 2000s music and 80s hip-hop!”</li>
<li><strong>TV guilty pleasure:</strong> <em>Barbie: Life in the Dreamhouse</em> – her comfort show</li>
</ul>
</div>
</div><div class="modal presenter-modal" id="presenter-scott-ohare" style="z-index: 10001">
<div class="modal-content" style="max-width:600px;">
<span class="close" onclick="closePresenterModal('presenter-scott-ohare')">×</span>
<h2>Scott O’Hare</h2>
<!-- Presenter Image -->
<img alt="Scott O'Hare" src="Scott-OHare.jpg" style="width:100%;max-width:220px;margin-bottom:15px;border-radius:12px;"/>
<p>Oh yes! Scott eases you out of the workday on <strong>Essential Hometime</strong>, with upbeat tunes, campus updates and his trademark dry wit. OHH YESSSSS!!!!</p>
</div>
</div><div class="modal presenter-modal" id="presenter-faith-montgomery" style="z-index: 10001">
<div class="modal-content" style="max-width:600px;">
<span class="close" onclick="closePresenterModal('presenter-faith-montgomery')">×</span>
<h2>Faith Montgomery</h2>
<!-- Presenter Image -->
<img alt="Faith Montgomery" src="Faith-Montgomery.jpg" style="width:100%;max-width:220px;margin-bottom:15px;border-radius:12px;"/>
<p>Faith lights up Friday lunchtimes with a positive energy boost on her edition of <strong>Feelgood Lunch</strong>.</p>
<p>Faith has a background in performing arts and volunteers regularly for causes she cares about. Passionate about music, mental health and equality, she’s as comfortable at a festival as she is at an indie gig.</p>
<h3>Get to know Faith</h3>
<ul>
<li><strong>When do you pack for holiday?</strong> A week in advance – she plans her outfits!</li>
<li><strong>In the fridge:</strong> Monster and Red Bull (essentials!)</li>
<li><strong>Movie star alter-ego:</strong> Jenna Ortega</li>
<li><strong>Biography title:</strong> <em>Reputation of a Goth ⚕️</em></li>
<li><strong>Most bizarre experience:</strong> Standing up in her chair for the first time</li>
<li><strong>Most embarrassing moment:</strong> Being sick on stage</li>
<li><strong>Dream app:</strong> A kettle-lifter to make coffee</li>
<li><strong>Spotify shame:</strong> “No!! Way too much alternative music”</li>
<li><strong>TV guilty pleasure:</strong> <em>Coronation Street</em></li>
</ul>
</div>
</div><div class="modal presenter-modal" id="presenter-lee-everest" style="z-index: 10001">
<div class="modal-content" style="max-width:600px;">
<span class="close" onclick="closePresenterModal('presenter-lee-everest')">×</span>
<h2>Lee Everest</h2>
<!-- Presenter Image -->
<img alt="Lee Everest" src="Lee-Everest.jpg" style="width:100%;max-width:220px;margin-bottom:15px;border-radius:12px;"/>
<p>Lee brings the fire every weekend on <strong>Ready for the Weekend</strong> — a high-energy show bursting with bangers, feel-good beats and party-starting tunes to kick off your Saturday night in style.</p>
<p>Broadcasting from the South Coast, Lee’s all about upbeat vibes, floor-fillers and keeping you dancing from the first song to the last. Whether it’s fresh anthems or old-school floor-shakers, he’s got your weekend soundtrack sorted.</p>
<h3>Get to know Lee</h3>
<ul>
<li><strong>When do you pack for holiday?</strong> The day before – keeps things exciting!</li>
<li><strong>In the fridge:</strong> Milk, cheese and a stash of yoghurts.</li>
<li><strong>Movie star alter-ego:</strong> Jim Carrey – unpredictable energy guaranteed.</li>
<li><strong>Biography title:</strong> <em>You Win Some, You Lose Some</em></li>
<li><strong>Most bizarre experience:</strong> Flying over Las Vegas in a helicopter at night.</li>
<li><strong>Most embarrassing moment:</strong> Karaoke on stage in Brighton. Enough said.</li>
<li><strong>Dream app:</strong> One to control your home radio studio from your phone!</li>
<li><strong>Spotify shame:</strong> No shame – let’s go live!</li>
<li><strong>TV guilty pleasure:</strong> <em>From the Earth to the Moon</em></li>
<li><strong>When he's not on Essential Radio:</strong> Watching documentaries and tuning in to other dance shows for inspiration.</li>
</ul>
</div>
</div><div class="modal presenter-modal" id="presenter-ronny-costello" style="z-index: 10001">
<div class="modal-content" style="max-width:600px;">
<span class="close" onclick="closePresenterModal('presenter-ronny-costello')">×</span>
<h2>Ronny Costello</h2>
<!-- Presenter Image -->
<img alt="Ronny Costello" src="Ronny-Costello.jpg" style="width:100%;max-width:220px;margin-bottom:15px;border-radius:12px;"/>
<p>Ronny brings the energy every week on <strong>Club Classics</strong> — a high-octane hour of dance anthems, floor-fillers and old-school bangers from across the decades. Expect non-stop throwbacks, forgotten gems and iconic club tunes mixed with love.</p>
<p>He caught the DJ bug on a Magaluf holiday in 1999, watching Seb Fontaine work the decks at BCM. A Numark DJ-in-a-box set and a stack of vinyl later, his journey began. Those records? Still in his mum’s loft.</p>
<p>From hospital radio to commercial stations and now award-winning shows and podcasts, Ronny’s been in the game since 2000 — and still spends most weekends behind the decks somewhere!</p>
<p>For more, follow <strong>@thisisclubclassics</strong> on Instagram &amp; Facebook or visit <a href="https://clubclassicsradioshow.com" target="_blank">clubclassicsradioshow.com</a>.</p>
<h3>Get to know Ronny</h3>
<ul>
<li><strong>When do you pack for holiday?</strong> Probably while the taxi’s on the way.</li>
<li><strong>In the fridge:</strong> Energy drinks and leftover pizza. Essentials only.</li>
<li><strong>Movie star alter-ego:</strong> Martin Compston (with better dance moves).</li>
<li><strong>Biography title:</strong> <em>Beats, Banter &amp; BCM</em></li>
<li><strong>Most bizarre experience:</strong> DJing in a lift. Yes, an actual working lift.</li>
<li><strong>Most embarrassing moment:</strong> Pressing stop instead of play mid-set. Club went silent. Mortified.</li>
<li><strong>Dream app:</strong> One that beams you straight to Ibiza.</li>
<li><strong>Spotify shame:</strong> Probably that 90s boyband playlist. No further questions.</li>
<li><strong>TV guilty pleasure:</strong> <em>Gladiators</em>. Old and new. He’s obsessed.</li>
<li><strong>When he's not on Essential Radio:</strong> DJing, podcasting, or trying not to buy more vinyl.</li>
</ul>
</div>
</div><div class="modal presenter-modal" id="presenter-david-southway" style="z-index: 10001">
<div class="modal-content" style="max-width:600px;">
<span class="close" onclick="closePresenterModal('presenter-david-southway')">×</span>
<h2>David Southway</h2>
<!-- Presenter Image -->
<img alt="David Southway" src="David-Southway.jpg" style="width:100%;max-width:220px;margin-bottom:15px;border-radius:12px;"/>
<p>David is the voice behind <strong>Soul Vaults</strong>, a show that celebrates the rich heritage of soul music — not just playing the classics, but sharing the stories behind them. His background in radio dates back to 1970 as one of the first DJs on BBC Radio Bristol and he’s stayed connected to broadcasting ever since.</p>
<p>Balancing life in business and radio, David has worked across major commercial stations in the South of England including GWR, Classic Gold, WFM and Star. With a deep knowledge of old soul and a passion for its legacy, Soul Vaults is more than just a playlist — it's a guided journey through a golden genre.</p>
<h3>Get to know David</h3>
<ul>
<li><strong>When do you pack for holiday?</strong> Usually the day before — time-honoured tradition!</li>
<li><strong>In the fridge:</strong> Sunday? Full. Ask again Friday and it might be a different story.</li>
<li><strong>Movie star alter-ego:</strong> Himself. “I need the money.”</li>
<li><strong>Biography title:</strong> <em>Yer Tiz</em> – a West Country phrase meaning “Here it is.” (Written and published!)</li>
<li><strong>Most bizarre experience:</strong> Getting mugged in Las Vegas — and being told he was *lucky* it wasn’t worse.</li>
<li><strong>Most embarrassing moment:</strong> Using the ladies’ loo in a London hotel… door open… mid-flow… full audience. Say no more.</li>
<li><strong>Dream app:</strong> Something that helps you *avoid* the wrong toilet.</li>
<li><strong>Spotify shame:</strong> No shame – it’s a solid mix of old and new soul, always.</li>
<li><strong>TV guilty pleasure:</strong> Not Love Island... but he's *heard* the scenery’s nice.</li>
<li><strong>When he's not on Essential Radio:</strong> Researching, scripting and compiling the next visit to the Soul Vaults – a true labour of love.</li>
</ul>
</div>
</div><div class="modal presenter-modal" id="presenter-davy-sims" style="z-index: 10001">
<div class="modal-content" style="max-width:600px;">
<span class="close" onclick="closePresenterModal('presenter-davy-sims')">×</span>
<h2>Davy Sims</h2>
<!-- Presenter Image -->
<img alt="Davy Sims" src="Davy-Sims.jpg" style="width:100%;max-width:220px;margin-bottom:15px;border-radius:12px;"/>
<p>Davy presents <strong>Around the World</strong>, bringing you global sounds from every corner of the planet. It’s a journey through world music, informed by decades of radio experience and a serious vinyl and digital collection.</p>
<p>His broadcasting career began in 1979 at Downtown Radio, then the BBC — including Radio 1 and Radio Ulster — before leading BBC NI’s New Media team. Since “retirement,” he’s kept busy producing syndicated radio, contributing to global music charts and jetting off to music conferences across Europe.</p>
<p>Find out more at <a href="https://www.davysims.com" target="_blank">davysims.com</a>.</p>
<h3>Get to know Davy</h3>
<ul>
<li><strong>When do you pack for holiday?</strong> Starts thinking months in advance, but packs properly 3 days before — with weighing sessions.</li>
<li><strong>In the fridge:</strong> The basics. In the freezer? Who knows — apart from the missing ice cream.</li>
<li><strong>Movie star alter-ego:</strong> Brian Cox (because Holywood deserves Hollywood).</li>
<li><strong>Biography title:</strong> <em>Sound</em></li>
<li><strong>Most bizarre experience:</strong> Peter Gabriel turning up unannounced and sitting at his desk at Radio 1.</li>
<li><strong>Most embarrassing moment:</strong> Also Peter Gabriel. Same moment. Still recovering.</li>
<li><strong>Dream app:</strong> Something that gives you proper privacy.</li>
<li><strong>Spotify shame:</strong> No shame — though he’s more of an iTunes guy. Username: “davysims”.</li>
<li><strong>TV guilty pleasure:</strong> <em>The Young Montalbano</em></li>
<li><strong>When he's not on Essential Radio:</strong> Listening for the World Music Charts, travelling to music events across Europe and spending time in Slovenia whenever he can.</li>
</ul>
</div>
</div><div class="modal presenter-modal" id="presenter-big-tommy" style="z-index: 10001">
<div class="modal-content" style="max-width:600px;">
<span class="close" onclick="closePresenterModal('presenter-big-tommy')">×</span>
<h2>Big Tommy</h2>
<!-- Presenter Image -->
<img alt="Big Tommy" src="Big-Tommy.jpg" style="width:100%;max-width:220px;margin-bottom:15px;border-radius:12px;"/>
<p>Big Tommy (Tommy Martin) brings the party every Saturday with his legendary <strong>Saturday Music Marathon</strong> and <strong>Big Fat Party Anthems</strong>. Expect full-on throwbacks, megamixes and a bingo ball or two.</p>
<p>He’s been behind the mic since the mid-2000s after years of DJing around Glasgow and Lanarkshire in the 80s and 90s. When he’s not playing your favourite 70s and 80s tunes, you’ll probably find him enjoying a well-earned Chinese takeaway or trying to convince the team that <em>Emmerdale</em> is quality telly.</p>
<h3>Get to know Big Tommy</h3>
<ul>
<li><strong>When do you pack for holiday?</strong> A day before – but he swears he’s not disorganised!</li>
<li><strong>In the fridge:</strong> A chilled bottle of Irn Bru – obviously.</li>
<li><strong>Movie star alter-ego:</strong> Mel Gibson (brave choice).</li>
<li><strong>Biography title:</strong> <em>Confessions of a Fairground Worker</em></li>
<li><strong>Most bizarre experience:</strong> Getting 4 numbers up on the lottery – and telling everyone about it since.</li>
<li><strong>Most embarrassing moment:</strong> None. Not even one. Honest.</li>
<li><strong>Dream app:</strong> A solar-powered one – eco vibes!</li>
<li><strong>Spotify shame:</strong> “Let me think about that...”</li>
<li><strong>TV guilty pleasure:</strong> <em>Emmerdale</em> (don’t judge).</li>
<li><strong>When he's not on Essential Radio:</strong> Chilling out with good music and great food.</li>
</ul>
</div>
</div><div class="modal presenter-modal" id="presenter-jan-gow" style="z-index: 10001">
<div class="modal-content" style="max-width:600px;">
<span class="close" onclick="closePresenterModal('presenter-jan-gow')">×</span>
<h2>Jan Gow</h2>
<!-- Presenter Image -->
<img alt="Jan Gow" src="Jan-Gow.jpg" style="width:100%;max-width:220px;margin-bottom:15px;border-radius:12px;"/>
<p>Jan presents <strong>The JanCave Jukebox Years</strong> — a one-hour nostalgic celebration of 70s pop culture, music and memories. Each episode takes a trip through a single year of the decade, featuring personal favourites, artist stories and the odd vintage TV clip for good measure.</p>
<p>Born in 1964 (she insists we include that), Jan brings her cheeky humour, deep affection for 70s music and photographic flair to the show. She’s also a professional photographer and, in her words, “handy with an airbrush” — though it’s mostly just great lighting and even better vibes.</p>
<p>Broadcast on over a dozen stations — including Saturdays at 5pm on Essential Radio — The JanCave Jukebox Years is where retro reigns supreme.</p>
<h3>Get to know Jan</h3>
<ul>
<li><strong>Favourite musical decade:</strong> The 70s — loud, colourful and full of character.</li>
<li><strong>Best compliment received:</strong> “You don’t look old enough to remember the 70s!”</li>
<li><strong>Fun fact:</strong> She still owns every vinyl record she ever bought (and alphabetised them last lockdown).</li>
<li><strong>Most likely to say:</strong> “You should’ve gone to Specsavers.”</li>
<li><strong>When she's not on Essential Radio:</strong> Taking photos, digging through retro playlists and wondering why she didn’t keep more 70s flares.</li>
</ul>
</div>
</div><div class="modal presenter-modal" id="presenter-spencer-james" style="z-index: 10001">
<div class="modal-content" style="max-width:600px;">
<span class="close" onclick="closePresenterModal('presenter-spencer-james')">×</span>
<h2>Spencer James</h2>
<!-- Presenter Image -->
<img alt="Spencer James" src="Spencer-James.jpg" style="width:100%;max-width:220px;margin-bottom:15px;border-radius:12px;"/>
<p>Spencer James is the host of <strong>Airplay40</strong> — the weekly chart show compiled from airplay on over 250 English-speaking radio stations worldwide. It’s the Top 40 countdown that reflects the songs you’re really listening to right now, plus the latest showbiz news from Radio News Hub.</p>
<p>With nearly 30 years in media and over two decades on air, Spencer has worked across UK and international radio — from breakfast and drive shows in the South East of England, to running stations abroad and even flying above London and Essex as part of AA Roadwatch’s “flying eyes.” In 2008 he created a chart show for expat audiences which grew into today’s <strong>Airplay40</strong>.</p>
<p>Broadcast every week on Essential Radio, Airplay40 is your connection to what’s hot (and what’s not) in the world of music.</p>
<h3>Get to know Spencer</h3>
<ul>
<li><strong>Started in radio:</strong> While studying Film &amp; TV at the University of Wales, Aberystwyth.</li>
<li><strong>Previous roles:</strong> Presenter, Programme Manager, Promotions Manager, travel reporter… and briefly a film assistant director.</li>
<li><strong>Claim to fame:</strong> One of his short films was BAFTA-nominated.</li>
<li><strong>Biggest idea:</strong> Launching what became Airplay40 — now heard worldwide.</li>
<li><strong>When he’s not on air:</strong> Supporting England rugby, losing golf balls, or experimenting in the kitchen with mixed results.</li>
</ul>
</div>
</div><div class="modal presenter-modal" id="presenter-dr-hilary-jones" style="z-index: 10001">
<div class="modal-content" style="max-width:600px;">
<span class="close" onclick="closePresenterModal('presenter-dr-hilary-jones')">×</span>
<h2>Dr Hilary Jones</h2>
<!-- Presenter Image -->
<img alt="Dr Hilary Jones" src="Dr-Hilary-Jones.jpg" style="width:100%;max-width:220px;margin-bottom:15px;border-radius:12px;"/>
<p>Dr Hilary Jones is one of the UK’s most trusted health voices — and now hosts <strong>The Dr Hilary Show</strong>, a weekly podcast and radio series exploring health, hope and happiness through real-life stories, expert advice and candid conversation.</p>
<p>Whether it’s men’s mental health, chronic illness, fitness, grief, or breaking down medical myths, the show mixes heartfelt interviews with science-backed insight. Guests have included sports surgeons, Strictly contestants, musicians, grief coaches and patients fighting rare diseases — all brought together by Hilary’s calm, compassionate style.</p>
<p>Listeners are also invited to send in their own questions for his <strong>Ask Dr Hilary</strong> segment, where he shares practical advice on everything from sleep and diet to anxiety and everyday wellbeing. It’s about empowerment, education — and making good health feel achievable.</p>
<h3>Get to know Dr Hilary</h3>
<ul>
<li><strong>Started in TV:</strong> Over 30 years ago — and still going strong.</li>
<li><strong>Favourite topic:</strong> When medicine meets the human story.</li>
<li><strong>Signature question:</strong> “How are you, really?”</li>
<li><strong>When he's not on air:</strong> Writing, walking, or quietly refusing to endorse miracle face creams on Facebook.</li>
<li><strong>Ask Dr Hilary:</strong> Email <a href="mailto:Ask@drhilaryjones.com">Ask@drhilaryjones.com</a> to have your health questions answered on the show.</li>
</ul>
</div>
</div><div class="modal presenter-modal" id="presenter-tim-graham" style="z-index: 10001">
<div class="modal-content" style="max-width:600px;">
<span class="close" onclick="closePresenterModal('presenter-tim-graham')">×</span>
<h2>Tim Graham</h2>
<!-- Presenter Image -->
<img alt="Tim Graham" src="Tim-Graham.jpeg" style="width:100%;max-width:220px;margin-bottom:15px;border-radius:12px;"/>
<p>Tim hosts the weekly <strong>LGBTQ Music Chart Radio Show</strong> — a global celebration of LGBTQ music, voices and talent. Syndicated across multiple stations and growing fast, the show champions chart-topping anthems and brand-new discoveries from LGBTQ artists around the world.</p>
<p>Each Saturday, Tim counts down the top tracks, shares new releases from <em>Outed On Friday</em> and keeps listeners connected to the pulse of the LGBTQ+ music scene. Whether you’re discovering your next queer anthem or reliving a favourite, this show brings community, colour and creativity to the airwaves.</p>
<p>Catch the show Sundays at 6pm on Essential Radio, or visit <a href="https://lgbtqmusicchart.uk" target="_blank">lgbtqmusicchart.uk</a> to explore the full chart and voting schedule.</p>
<h3>Get to know Tim</h3>
<ul>
<li><strong>What drives the show:</strong> Elevating LGBTQ+ voices through the power of music.</li>
<li><strong>Favourite part of the job:</strong> Watching queer artists climb the chart and find new fans every week.</li>
<li><strong>Most played artist lately:</strong> Always changing – but there’s a soft spot for Rhian!, Asbjørn and Robert O’Connor.</li>
<li><strong>Guilty pleasure:</strong> Tallying the votes like it's Eurovision.</li>
<li><strong>When he's not on air:</strong> Updating the chart, scouting new releases and supporting LGBTQ music from behind the scenes.</li>
</ul>
</div>
</div><div class="modal presenter-modal" id="presenter-stephen-howie" style="z-index: 10001">
<div class="modal-content" style="max-width:600px;">
<span class="close" onclick="closePresenterModal('presenter-stephen-howie')">×</span>
<h2>Stephen Howie</h2>
<!-- Presenter Image -->
<img alt="Stephen Howie" src="Stephen-Howie.jpg" style="width:100%;max-width:220px;margin-bottom:15px;border-radius:12px;"/>
<p>Stephen brings the soul with <strong>Grooveline</strong> — a genre-hopping celebration of classic and modern soul, jazz-funk, acid jazz and more. Broadcasting since 1998, his show has reached audiences in the UK, Europe, Africa and beyond.</p>
<p>With guests like Bluey from Incognito and DJ legend John Morales, Grooveline is recorded at his base in London and packed with groove to move you — every single week.</p>
<h3>Get to know Stephen</h3>
<ul>
<li><strong>When do you pack for holiday?</strong> The night before, no matter what. Half an hour tops.</li>
<li><strong>In the fridge:</strong> Half-used jars, milk and herbs clinging to life.</li>
<li><strong>Movie star alter-ego:</strong> Gerard Butler (obviously).</li>
<li><strong>Biography title:</strong> <em>The Soulful Scotsman</em></li>
<li><strong>Most bizarre experience:</strong> Detained and questioned as a suspected spy in Naxçıvan.</li>
<li><strong>Most embarrassing moment:</strong> Tripping across the floor at karaoke just before singing “What Is Love?”.</li>
<li><strong>Dream app:</strong> 24/7 hash brown delivery. Essential.</li>
<li><strong>Spotify shame:</strong> None – but brace yourself for a perty.</li>
<li><strong>TV guilty pleasure:</strong> <em>EastEnders</em>. Every single episode from 1985 to now (with a couple of gaps).</li>
<li><strong>When he's not on Essential Radio:</strong> Far, far too much. Probably still not sitting still.</li>
</ul>
</div>
</div><div class="modal presenter-modal" id="presenter-bill-grainger" style="z-index: 10001">
<div class="modal-content" style="max-width:600px;">
<span class="close" onclick="closePresenterModal('presenter-bill-grainger')">×</span>
<h2>Bill Grainger</h2>
<!-- Presenter Image -->
<img alt="Bill Grainger" src="Bill-Grainger.jpg" style="width:100%;max-width:220px;margin-bottom:15px;border-radius:12px;"/>
<p>Bill Grainger was a legend of the Scottish club scene and the driving force behind <strong>The Hi-NRG Show</strong> on Essential Radio — two hours of classic floorfillers, 12-inch anthems and high-energy club culture, broadcast every Sunday from midnight.</p>
<p>From his early days DJing at Edinburgh’s legendary <strong>Fire Island</strong> nightclub to guest spots on <strong>Radio Clyde</strong> and running <strong>Clubscene Records</strong>, Bill helped define the Scottish HI-NRG and dance landscape through the 70s, 80s and beyond. He promoted acts, launched magazines and gave a platform to artists long before the mainstream caught on.</p>
<p>Bill's encyclopaedic knowledge and infectious passion for dance music made every show feel like a trip back to the golden age of clubbing — bold, bright and bursting with energy. His legacy lives on through the music, the memories and every beat he ever dropped.</p>
<h3>Get to know Bill</h3>
<ul>
<li><strong>Favourite genre:</strong> Pure HI-NRG — unapologetically loud, proud and powerful.</li>
<li><strong>Scene roots:</strong> Fire Island, Princes Street. A dancefloor institution.</li>
<li><strong>Industry impact:</strong> Founder of Clubscene Records, promoter, tastemaker, radio icon.</li>
<li><strong>On Essential Radio:</strong> His Hi-NRG Show kept the spirit of the clubs alive every weekend.</li>
<li><strong>Legacy:</strong> A pioneer who shaped Scotland’s dance culture with passion and pride.</li>
</ul>
</div>
</div><div class="modal presenter-modal" id="presenter-kevin-mccallum" style="z-index: 10001">
<div class="modal-content" style="max-width:600px;">
<span class="close" onclick="closePresenterModal('presenter-kevin-mccallum')">×</span>
<h2>Kevin McCallum</h2>
<!-- Presenter Image -->
<img alt="Kevin McCallum" src="Kevin-Mccallum.jpg" style="width:100%;max-width:220px;margin-bottom:15px;border-radius:12px;"/>
<p>Kevin is the voice of <strong>The Mr Rocks Show</strong> — a weekly two-hour journey through classic and contemporary heavy rock. From Led Zeppelin to Scarlet Rebels, it’s a personal playlist shaped by over 45 years of gig-going, reviewing and loving loud guitars.</p>
<p>The show brings together timeless rock anthems and fresh new discoveries, along with artist interviews and gig highlights from Kevin’s extensive experience in the rock scene. His passion is infectious and his knowledge runs deep — from ACDC at the Apollo in 1980 to Dirty Honey in 2022, he's lived it.</p>
<p>Kevin launched his first show in 2020 and now records from home, sending out the Mr Rocks Show to a growing network of stations — all fuelled by a lifelong obsession with powerful music and the stories behind it.</p>
<h3>Get to know Kevin</h3>
<ul>
<li><strong>When do you pack for holiday?</strong> A week before — organised rocker.</li>
<li><strong>In the fridge:</strong> Grapes, milk, cheese — and probably more cheese.</li>
<li><strong>Movie star alter-ego:</strong> Al Pacino (or Jack Nicholson if he’s busy).</li>
<li><strong>Biography title:</strong> <em>Who?</em></li>
<li><strong>Most bizarre experience:</strong> Wine and cheese with Mick Ralphs, talking through the making of “Feel Like Making Love”.</li>
<li><strong>Most embarrassing moment:</strong> Helping everyone else get their passports sorted… then realising he’d forgotten his own.</li>
<li><strong>Dream app:</strong> One that automatically cuts your grass. Please.</li>
<li><strong>Spotify shame:</strong> Hook it up — no problem!</li>
<li><strong>TV guilty pleasure:</strong> <em>Dickinson’s Real Deal</em></li>
<li><strong>When he's not on Essential Radio:</strong> Family time, live gigs, reviewing new rock releases and summer cricket.</li>
</ul>
</div>
</div><div class="modal presenter-modal" id="presenter-emma-scott" style="z-index: 10001">
<div class="modal-content" style="max-width:600px;">
<span class="close" onclick="closePresenterModal('presenter-emma-scott')">×</span>
<h2>Emma Scott</h2>
<!-- Presenter Image -->
<img alt="Emma Scott" src="Emma-Scott.jpg" style="width:100%;max-width:220px;margin-bottom:15px;border-radius:12px;"/>
<p>Emma Scott is the force behind <strong>The Pluggin’ Baby Radio Show</strong> — a two-hour blast of guitar-driven music that celebrates the best in independent rock alongside tracks from icons like Foo Fighters, Green Day, Paramore and Muse (her ultimate fave).</p>
<p>Launched in 2022, the show features exclusive interviews, acoustic sessions and fresh new talent from around the world. It’s where future festival headliners meet seasoned legends — and Emma’s passion for powerful music shines through every week.</p>
<p>A true radio veteran, Emma’s voice is already familiar to listeners of Kerrang! Radio, Metro FM, Power FM, Galaxy, Heart and more. Her decades in the industry have been spent championing new music with unmatched energy and heart.</p>
<p>Don’t miss her weekly feature <strong>Killer Cover</strong>, where rock bands take on pop classics — and you can even suggest your own via <a href="mailto:radioshow@plugginbaby.com">radioshow@plugginbaby.com</a>.</p>
<h3>Get to know Emma</h3>
<ul>
<li><strong>Started in radio:</strong> 1988 – and hasn’t stopped rocking since.</li>
<li><strong>Show named after:</strong> A Muse song. Of course.</li>
<li><strong>What to expect:</strong> Guitars, guts, energy and Emma’s unmistakable passion.</li>
<li><strong>When she’s not on air:</strong> She’s probably discovering your new favourite band.</li>
<li><strong>Catch the show:</strong> Weekly on Essential Radio and stations across the UK.</li>
</ul>
</div>
</div><div class="modal presenter-modal" id="presenter-dave-watkins" style="z-index: 10001">
<div class="modal-content" style="max-width:600px;">
<span class="close" onclick="closePresenterModal('presenter-dave-watkins')">×</span>
<h2>Dave Watkins</h2>
<!-- Presenter Image -->
<img alt="Dave Watkins" src="Dave-Watkins.jpg" style="width:100%;max-width:220px;margin-bottom:15px;border-radius:12px;"/>
<p>Dave presents <strong>The Country Mile</strong> — a weekly show packed with real, authentic country music. From honky tonk and bluegrass to outlaw and Ameripolitan, it’s a handpicked selection of brand new tracks from across the genre.</p>
<p>Broadcast from his home studio in Devon and now syndicated worldwide, the show has grown steadily since launching in 2017. Country fans can catch up via <a href="https://hearthis.at/thecountrymile" target="_blank">hearthis.at/thecountrymile</a> or find more at <a href="https://facebook.com/thecountrymile" target="_blank">facebook.com/thecountrymile</a>.</p>
<h3>Get to know Dave</h3>
<ul>
<li><strong>When do you pack for holiday?</strong> Usually a couple of days before – if he ever gets the chance!</li>
<li><strong>In the fridge:</strong> Milk, cheese, bacon… and a few cans of cloudy cider.</li>
<li><strong>Movie star alter-ego:</strong> Someone charming, funny and far too good-looking.</li>
<li><strong>Biography title:</strong> <em>OK At Radio, Bad At Jokes</em></li>
<li><strong>Most bizarre experience:</strong> Interviewing Bruce Watson… then Jimmy Tarbuck. Very different vibes.</li>
<li><strong>Most embarrassing moment:</strong> His entire teenage fashion phase.</li>
<li><strong>Dream app:</strong> One that secretly doubles his wages.</li>
<li><strong>Spotify shame:</strong> “I’ve got awesome taste — plug it in!”</li>
<li><strong>TV guilty pleasure:</strong> Accidentally getting into <em>90 Day Fiancé</em>.</li>
<li><strong>When he's not on Essential Radio:</strong> Working for the NHS, walking on Dartmoor, or spending time with family and music.</li>
</ul>
</div>
</div><div class="modal presenter-modal" id="presenter-brian-woolfson" style="z-index: 10001">
<div class="modal-content" style="max-width:600px;">
<span class="close" onclick="closePresenterModal('presenter-brian-woolfson')">×</span>
<h2>Brian Woolfson</h2>
<!-- Presenter Image -->
<img alt="Brian Woolfson" src="Brian-Woolfson.jpg" style="width:100%;max-width:220px;margin-bottom:15px;border-radius:12px;"/>
<p>Woolfy is the man behind <strong>Retro Charts</strong> — Essential Radio’s weekly dose of classic UK Top 20s. Whether it’s the glitter of the 70s, synths of the 80s, heartbreak of the 90s or pop chaos of the 00s, Woolfy delivers the facts, the flops, the trivia and the tunes you forgot you loved.</p>
<p>With over 20 years of radio under his belt (Q96, Real Radio, Clyde 1, Central FM, Nation Radio Scotland and more), he’s a walking chart archive with a habit of remembering peak positions from 1989 better than where he left his keys.</p>
<p>Woolfy’s countdowns are packed with pop nostalgia, artist stories and masses of chart stats. If you love the UK charts, you’ll love this show — even if you still think “Reef – Place Your Hands” was a Number 1 (spoiler: it wasn’t).</p>
<h3>Get to know Woolfy</h3>
<ul>
<li><strong>When do you pack for holiday?</strong> Either a fortnight early… or during the Uber ride.</li>
<li><strong>In the fridge:</strong> Out-of-date condiments and a lot of fizzy water pretending to be healthy.</li>
<li><strong>Movie star alter-ego:</strong> George Clooney. It came up in a quiz once and he’s stuck with it.</li>
<li><strong>Biography title:</strong> <em>Thanks for Listening</em> – he says it after every show, and he means it (mostly).</li>
<li><strong>Most bizarre experience:</strong> Being forced to drink “venoms” at the Savoy in Glasgow by a radio colleague. Never again.</li>
<li><strong>Most embarrassing moment:</strong> Saying the wrong station name live on his first show. Ask any Scottish radio presenter.</li>
<li><strong>Dream app:</strong> One that names obscure celebs on TV shows. Looking at you, Celebrity Mastermind.</li>
<li><strong>Spotify shame:</strong> “Turtle Power”, “Itsy Bitsy Teeny Weeny...” and Anita Dobson's EastEnders single. All for research. Honest.</li>
<li><strong>TV guilty pleasure:</strong> Coronation Street. Apparently he’s part Roy, part Brian, part Norris. No further questions.</li>
<li><strong>When he's not on air:</strong> Teaching, compiling charts, curating his Now That’s What I Call Music collection, or correcting your chart trivia on X.</li>
</ul>
</div>
</div><div class="modal presenter-modal" id="presentersModal" style="z-index: 2050">
<div class="modal-content" style="max-width:1020px;width:95vw;">
<span class="close" onclick="closeModal('presentersModal')">×</span>
<h2 style="color:#00818a;margin-top:0;margin-bottom:20px;text-align:center;">Meet the Essential Radio Presenters</h2>
<div class="presenters-grid">
<a class="presenter-card" href="#" onclick="openPresenterModal('presenter-paul-woodland');return false;">
<img alt="Paul Woodland" src="Paul-Woodland.jpg"/>
<h3>Paul Woodland</h3>
<p>Essential Breakfast</p>
</a>
<a class="presenter-card" href="#" onclick="openPresenterModal('presenter-bex-mcnamee');return false;">
<img alt="Bex McNamee" src="Bex-Mcnamee.jpg"/>
<h3>Bex McNamee</h3>
<p>Feelgood Lunch &amp; The Midweek Mash-Up</p>
</a>
<a class="presenter-card" href="#" onclick="openPresenterModal('presenter-scott-ohare');return false;">
<img alt="Scott O'Hare" src="Scott-OHare.jpg"/>
<h3>Scott O'Hare</h3>
<p>Essential Hometime</p>
</a>
<a class="presenter-card" href="#" onclick="openPresenterModal('presenter-faith-montgomery');return false;">
<img alt="Faith Montgomery" src="Faith-Montgomery.jpg"/>
<h3>Faith Montgomery</h3>
<p>Feelgood Lunch</p>
</a>
<a class="presenter-card" href="#" onclick="openPresenterModal('presenter-david-southway');return false;">
<img alt="David Southway" src="David-Southway.jpg"/>
<h3>David Southway</h3>
<p>Soul Vaults</p>
</a>
<a class="presenter-card" href="#" onclick="openPresenterModal('presenter-lee-everest');return false;">
<img alt="Lee Everest" src="Lee-Everest.jpg"/>
<h3>Lee Everest</h3>
<p>Ready for the Weekend</p>
</a>
<a class="presenter-card" href="#" onclick="openPresenterModal('presenter-ronny-costello');return false;">
<img alt="Ronny Costello" src="Ronny-Costello.jpg"/>
<h3>Ronny Costello</h3>
<p>Club Classics</p>
</a>
<a class="presenter-card" href="#" onclick="openPresenterModal('presenter-davy-sims');return false;">
<img alt="Davy Sims" src="Davy-Sims.jpg"/>
<h3>Davy Sims</h3>
<p>Around the World</p>
</a>
<a class="presenter-card" href="#" onclick="openPresenterModal('presenter-big-tommy');return false;">
<img alt="Big Tommy" src="Big-Tommy.jpg"/>
<h3>Big Tommy</h3>
<p>Saturday Music Marathon &amp; Party Anthems</p>
</a>
<a class="presenter-card" href="#" onclick="openPresenterModal('presenter-jan-gow');return false;">
<img alt="Jan Gow" src="Jan-Gow.jpg"/>
<h3>Jan Gow</h3>
<p>70s Jukebox</p>
</a>
<a class="presenter-card" href="#" onclick="openPresenterModal('presenter-tim-graham');return false;">
<img alt="Tim Graham" src="Tim-Graham.jpeg"/>
<h3>Tim Graham</h3>
<p>LGBTQ Music Chart</p>
</a>
<a class="presenter-card" href="#" onclick="openPresenterModal('presenter-stephen-howie');return false;">
<img alt="Stephen Howie" src="Stephen-Howie.jpg"/>
<h3>Stephen Howie</h3>
<p>Grooveline</p>
</a>
<a class="presenter-card" href="#" onclick="openPresenterModal('presenter-bill-grainger');return false;">
<img alt="Bill Grainger" src="Bill-Grainger.jpg"/>
<h3>Bill Grainger</h3>
<p>Fire Island Hi-NRG</p>
</a>
<a class="presenter-card" href="#" onclick="openPresenterModal('presenter-kevin-mccallum');return false;">
<img alt="Kevin McCallum" src="Kevin-Mccallum.jpg"/>
<h3>Kevin McCallum</h3>
<p>Mr Rocks Show</p>
</a>
<a class="presenter-card" href="#" onclick="openPresenterModal('presenter-emma-scott');return false;">
<img alt="Emma Scott" src="Emma-Scott.jpg"/>
<h3>Emma Scott</h3>
<p>Pluggin' Baby Radio Show</p>
</a>
<a class="presenter-card" href="#" onclick="openPresenterModal('presenter-dave-watkins');return false;">
<img alt="Dave Watkins" src="Dave-Watkins.jpg"/>
<h3>Dave Watkins</h3>
<p>The Country Mile</p>
</a>
<a class="presenter-card" href="#" onclick="openPresenterModal('presenter-brian-woolfson');return false;">
<img alt="Brian Woolfson" src="Brian-Woolfson.jpg"/>
<h3>Brian Woolfson</h3>
<p>Retro Charts</p>
</a>
<a class="presenter-card" href="#" onclick="openPresenterModal('presenter-spencer-james');return false;">
<img alt="Spencer James" src="Spencer-James.jpg"/>
<h3>Spencer James</h3>
<p>Airplay40</p>
</a>
</div>
<!-- PRESENTERS MODAL STYLES -->
<style>
      .presenters-grid {
        display: grid;
...
function toggleLogoVisibility() {
  ...
  if (logo) logo.style.display = anyModalOpen ? 'none' : 'block';
}

function closeAllModals() {
  document.querySelectorAll('.modal').forEach(modal => {
    if (modal.id !== 'presentersModal') {
      modal.style.display = 'none';
    }
  });
  const presentersOpen = document.getElementById('presentersModal')?.style.display === 'block';
  if (!presentersOpen) document.body.classList.remove('modal-open');
...
function openModal(id) {
  ...
  if (modal) {
    modal.style.display = 'block';
    modal.style.zIndex = id === 'requestsModal' ? '2500' : '2000';
    document.body.classList.add('modal-open');
  }
  toggleLogoVisibility();
}
...
<!-- === Modal Behavior Overrides (Injected) === -->
<script id="modal-behavior-overrides">
(function(){
  ...
  // Allow ON AIR NOW box to open the live presenter's modal (if present)
  function openLivePresenterModal(){
    // Try to find a slug from text like "with Stephen Howie"
    const el = document.querySelector('#currentShow .presenter-name') || document.querySelector('#currentShow');
    if (!el) return;

    const raw = (el.textContent || '').trim();
    if (!raw) return;

    // Expect ids like "presenter-stephen-howie"
    const slug = raw
      .toLowerCase()
    ...
    for (const id of candidateIds) {
      const modal = document.getElementById(id);
      if (modal) {
        openPresenterModal(id);
        return;
      }
    }
    // Fallback: ensure Presenters modal is open if no specific match
    if (document.getElementById('presentersModal')) {
      openModal('presentersModal');
    }
  }
  ...
  window.openLivePresenterModal = openLivePresenterModal;
  window.openModalAndCloseBurger = openModalAndCloseBurger;
})();
</script>
<script id="presenter-stack-shim">
(function(){
...
<div class="modal" data-refresh-fn="fetchRNHNews" id="newsModal">
<div class="modal-content" style="max-width:900px;width:97vw;">
<span class="close" onclick="closeModal('newsModal')">×</span>
<div style="display:flex;align-items:center;gap:18px;margin-bottom:24px;">
<h2 style="margin:0;color:#00818a;font-size:1.35em;">Scottish &amp; National News</h2>
</div>
...
<!-- Scottish News Section -->
<div style="margin-bottom:22px;">
<h3 style="color:#62c7fc;margin:0 0 9px 0;font-size:1.12em;display:flex;align-items:center;gap:10px;">
<span>🏴 Scottish News Update</span>
<span id="scotNewsTime" style="font-weight:normal;font-size:0.97em;color:#80dfff;"></span>
</h3>
<pre id="scottishNewsText" style="font-family:inherit;white-space:pre-wrap;background:transparent;border:none;padding:0;margin:0;font-size:1.05em;line-height:1.65;color:#d4f2ff;">Loading...</pre>
</div>
<!-- National News Section -->
<div>
<h3 style="color:#00e0ff;margin:0 0 9px 0;font-size:1.15em;">📰 The Latest from Radio News Hub</h3>
<style>
  /* Modal news cards */
  .rnh-cards{
    display:grid;
...
<div class="rnh-cards" id="rnh-modal-list">
<div style="color:#bbb">Loading headlines…</div>
</div>
</div>
</div>
...
(function(){
  function applyTheme(t){
    ...
    if (btn){
      var lab = btn.querySelector('.mode-label');
      var emo = btn.querySelector('.mode-emoji');
      if (lab) lab.textContent = (t === 'light') ? 'Dark' : 'Light';
      if (emo) emo.textContent = (t === 'light') ? '🌙' : '☀️';
  ...
  function init(){
    var btn = document.getElementById('themeToggleBtn');
    if (!btn) return;
    // set initial from html[data-theme] or storage
    var root = document.documentElement;
    var saved = null; try { saved = localStorage.getItem('theme'); } catch(e){}
    var current = saved || root.getAttribute('data-theme') || (matchMedia('(prefers-color-scheme: light)').matches ? 'light' : 'dark');
    applyTheme(current);
...
(function(){
  ...
  function init(){
    var saved = null; try { saved = localStorage.getItem('theme'); } catch(e){}
    var current = saved || document.documentElement.getAttribute('data-theme') || (matchMedia('(prefers-color-scheme: light)').matches ? 'light' : 'dark');
    applyTheme(current);
    document.addEventListener('click', function(e){
      var btn = e.target.closest && e.target.closest('#themeToggleBtn');
      if (!btn) return;
      e.preventDefault();
      var next = (document.documentElement.getAttribute('data-theme') === 'light') ? 'dark' : 'light';
      applyTheme(next);
...
<!-- Enhancements JS: marquee, live highlight, share -->
<script>
(() => {
  const TZ = "Europe/London";
...
const liveBox = document.querySelector(".live-indicator");
 ...
 const getNowText = () => {
  ...
  function highlightLiveShows() {
    ...
    container.querySelectorAll(".live-now").forEach(el => el.classList.remove("live-now"));

    const now = toLondon(new Date());
    ...
    container.querySelectorAll(".day-card").forEach(dayCard => {
      ...
      dayCard.querySelectorAll(".show-entry").forEach(entry => {
        ...
        try { entry.style.setProperty('--now-flag', '\\"ON AIR NOW\\"'); } catch(e) {}
          }
        }
      });
    });
...
<!-- Robustness patch: keep Share button from disappearing if Now Playing re-renders -->
<script>
(function () {
...
<script id="schedule-highlight-logic">
(function() {
  ...
  function highlightCurrentShow() {
    const sched = document.getElementById("scheduleModal");
    if (sched && (sched.style.display === "block" || sched.classList.contains("show"))) { return; }

    const container = findScheduleContainer();
    if (!container) return;

    const now = nowMinutesLondon();
    let winner = null;

    entryNodes(container).forEach(node => {
      const range = extractRange(node);
      if (!range) return;
      const [s,e] = range;
      if (isNowWithin(s,e,now)) {
        winner = node;
      }
    });
    ...
    if (winner) {
      ...
      if (lastScrollId !== id) {
        lastScrollId = id;
        setTimeout(()=>{
          try { winner.scrollIntoView({behavior:'smooth', block:'center'}); } catch(e) {}
        }, 60);
      }
    }
  }
...
<script id="np-share-href-enhancer">
(function(){
...
<script id="np-share-move-to-front">
(function(){
...
<script id="np-share-click-clean">
(function(){
  function norm(p){
    if(!p) return "";
...
<script id="np-share-title-artist-extractor">
(function(){
...
<script id="modal-refresh-on-open">
...
<script id="presenter-click-hijack">
...
<script id="modal-a11y-focus-trap">
...
<div class="artist" id="mobileNpArtist"></div>


<script id="mobile-now-bar-js">
(function(){
...
<script id="mobile-now-bar-visibility">
(() => {
...
<!-- Mobile mini-player (single-line "Artist – Title") -->
<!-- Mobile mini-player (single-line "Artist – Title") -->
<div aria-label="Mini player" id="mobileNowBar" role="region">
<div id="mobileNowBar-inner">
<button aria-label="Play/Pause" id="mobilePlayBtn" title="Play/Pause">▷</button>
<div id="mobileNowText" title="Now Playing">Artist – Title</div>
</div>
</div>
<script id="mobile-mini-player-script">
(function () {
...
<script id="wire-refresh-yellow-both">
(function(){
